...
# 更新 / 仓库
REPO_URL = "https://github.com/nonoka-lab/nonoka-lab"
# 留空则不做在线更新检查；可填 GitHub Releases 的 latest API
UPDATE_API = "https://api.github.com/repos/nonoka-lab/nonoka-lab/releases/latest"
# 插件市场清单（远程 JSON，列出可用插件元数据）；可在 config 中覆盖
MARKET_URL = "https://raw.githubusercontent.com/nonoka-lab/nonoka-lab/main/market/plugins.json"
